...
import com.gxs.elphant.contract.SheHuiContract;
...
public class SheHuiPresenterImpl implements SheHuiContract.SheHuiPresenter {
    private SheHuiContract.SheHuiView mView;
    private List<NewsEntity.ResultBean.DataBean> mList = new ArrayList<>();
    private int currentPage = 0;

    @Override
    public void attachView(SheHuiContract.SheHuiView view) {
        this.mView = view;
    }
    ...
    public void getServiceData(final int code) {
        ...
        Observable<NewsEntity> keji = HttpClientUtil.getInstance().getApiService().getNews("shehui", "77ff047df618d89e053ac75588f9021e");
